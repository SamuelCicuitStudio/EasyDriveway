...
public:
    ...
    enum Domain : uint8_t {
        ...
        DOM_OTA, DOM_FW, DOM_USER, DOM__COUNT
    };
...
private:
    ...
    int    _sdCS   = SD_CS_PIN_DEFAULT;
    int    _sdSCK  = SD_SCK_PIN_DEFAULT;
    int    _sdMISO = SD_MISO_PIN_DEFAULT;
    int    _sdMOSI = SD_MOSI_PIN_DEFAULT;
};
