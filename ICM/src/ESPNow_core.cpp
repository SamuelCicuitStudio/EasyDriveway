/**************************************************************
 *  ESPNow_core.cpp — Core: lifecycle, utils, peers, queue, callbacks
 **************************************************************/
...
// Local helper only used in this TU
namespace {
...
: _cfg(cfg), _log(log), _rtc(rtc) { s_inst = this; }
