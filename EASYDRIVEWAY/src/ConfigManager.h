 ...
 */
 ...
 #include "Config/NVSConfig.h"        // strict 6-char keys & defaults

 // Include exactly one pins header based on role (enforced by your build)
#if   defined(NVS_ROLE_ICM)
  #include "Pin/ICM_PinsNVS.h"
  #include "Config/Config_ICM.h"  // Include Config.h for default values
#elif defined(NVS_ROLE_PMS)
  #include "Pin/PMS_PinsNVS.h"
  #include "Config/Config_PMS.h"  // Include Config.h for default values
#elif defined(NVS_ROLE_SENS)
  #include "Pin/SEN_PinsNVS.h"
  #include "Config/Config_SENS.h"  // Include Config.h for default values
#elif defined(NVS_ROLE_RELAY)
  #include "Pin/REL_PinsNVS.h"
  #include "Config/Config_REL.h"  // Include Config.h for default values
#else
  #error "Define one of NVS_ROLE_ICM / NVS_ROLE_PMS / NVS_ROLE_SENS / NVS_ROLE_RELAY before building."
#endif
